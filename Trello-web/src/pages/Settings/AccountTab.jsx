...
function AccountTab() {
  ...
  const submitChangeGeneralInformation = (data) => {
    ...
    if (displayName === currentUser?.displayName) {
      toast.warning('Nothing has changed. Please check again!');
      return;
    }
  ...
  const uploadAvatar = (e) => {
    ...
    toast.promise(
      ...
      // Dù có lỗi hay thành công thì phải clear giá trị của file input, nếu không sẽ không thể chọn cùng 1 file được
      e.target.value = '';
    });
  };
