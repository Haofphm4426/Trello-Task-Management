export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'Haofphm To Do List',
    description: 'App like Trello',
    type: 'public', // 'private'
    ...
    columns: [
      {
        ...
        cardOrderIds: ['card-id-07', 'card-id-02', 'card-id-03', 'card-id-05', 'card-id-04', 'card-id-06', 'card-id-01'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
            ...
            cover: 'https://haofphm.com/wp-content/uploads/2022/07/fair-mern-stack-advanced-banner-haofphm.jpg',
