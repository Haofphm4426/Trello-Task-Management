...
const login = async (req, res, next) => {
  try {
     ...
     * Đối với cái maxAge - thời gian sống của Cookie thì sẽ để tối đa 14 ngày, tùy dự án. Lưu ý thời gian sống của cookie khác với cái thời gian sống của token nhé. Đừng bị nhầm lẫn :D
     */
