...
const CARD_COLLECTION_SCHEMA = Joi.object({
  ...
  // Dữ liệu comments của Card sẽ nhúng - embedded vào bản ghi Card luôn như dưới đây:
...
// https://www.mongodb.com/docs/v6.0/reference/method/db.collection.updateMany/#examples
